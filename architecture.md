...
|---|---|---|---|---|
| IR (940nm, 38kHz modulated) | Director → bracelet | \<1 ms | 1-15m depending on transmitter power; line-of-sight | Range can be extended by external IR devices. Pixmob use commerical grade IR transmitter for stadiums to great effect. |
