...
notion_status: "synced 2026-05-31 - pulled from Notion v0.31 (new §1.2 Lighting design principles + §12.3 references). Tables converted to pipe-markdown, mention-page tag resolved."
---

# NocturNation Architecture Specification

**Status:** Draft v0.31 - early architecture document, expect substantial revision.
